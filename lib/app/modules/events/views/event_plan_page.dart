        ...
        itemBuilder: (BuildContext context, index) {
          return Column(
            children: [
              ...
              Obx(() => controller.selectedGuestImage.value.isEmpty
                  ? ImageContainer(
                      imagePath: controller.selectedGuestImage.value,
                      onTapOpenGallery: () {
                  ...
                  : ImageOpenContainer(
                      openedImagePath: controller.selectedGuestImage.value,
                      onTapRemoveImage: () {
              ...
              Padding(
                ...
                child: CommonInputField(
                  wrapper: controller.guestNameTextController,
                  hintText: 'Name',
                ),
              ),
              Align(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    controller.guestNameTextController.controller.text.isEmpty
                        ? Error_message('Error', 'Enter Valid Name or Image')
              ...
              Obx(() => controller.guestsImagesList.isEmpty
                  ? Text("")
                  : EventImageListView(
                      count: controller.guestsImagesList.length,
                      textLinkList: controller.guestsNamesList,
                      imagesList: controller.guestsImagesList,
                      icon: Icon(Icons.cancel),
                    )),
              const CommonEventTitle(text: 'Event Speaker'),
              Obx(() => controller.selectedGuestSpeakerImage.value.isEmpty
                  ? ImageContainer(
                      imagePath: controller.selectedGuestSpeakerImage.value,
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      onTapOpenGallery: () {
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.guestSpeakerTextController,
                  hintText: 'Name',
                ),
              ),
              Align(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    controller
                            .guestSpeakerTextController.controller.text.isEmpty
                        ? Error_message('Error', 'Enter Valid Name or Image')
                        : controller.onAddGuestsSpeakerList(
                            controller
                                .guestSpeakerTextController.controller.text,
                            controller.selectedGuestSpeakerImage.value);
                    controller.removeGuestSpeakerImage();
              ...
              Obx(() => controller.guestSpeakerImageList.isEmpty
                  ? Text("")
                  : EventImageListView(
                      count: controller.guestSpeakerImageList.length,
                      textLinkList: controller.guestSpeakerNamesList,
                      imagesList: controller.guestSpeakerImageList,
                      icon: Icon(Icons.cancel),
                    )),
              const CommonEventTitle(text: "Event Floor Plan"),
              Obx(() => controller.selectedEventFloorImage.value.isEmpty
                  ? ImageContainer(
                      imagePath: controller.selectedEventFloorImage.value,
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      onTapOpenGallery: () {
                  ...
                  : ImageOpenContainer(
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      openedImagePath: controller.selectedEventFloorImage.value,
                      onTapRemoveImage: () {
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventHostTextController,
                  hintText: 'Name',
                ),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventExpectedTextController,
                  hintText: 'Type here',
                ),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventInstructionTextController,
                  hintText: 'Type here',
                  maxLine: 3,
                ),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventTagsTextController,
                  hintText: 'Type here to add tags',
                ),
              ),
              const CommonEventTitle(text: 'Event Organizer'),
              Obx(() => controller.selectedOrganizerImage.value.isEmpty
                  ? ImageContainer(
                      imagePath: controller.selectedOrganizerImage.value,
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      onTapOpenGallery: () {
                  ...
                  : ImageOpenContainer(
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      openedImagePath: controller.selectedOrganizerImage.value,
                      onTapRemoveImage: () {
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventOrganizerTextController,
                  hintText: 'Name',
                ),
              ),
              Align(
                  ...
                  onTap: () {
                    controller.eventOrganizerTextController.controller.text
                        ...
                        : controller.onAddOrganizerList(
                            controller
                                .eventOrganizerTextController.controller.text,
              ...
              Obx(() => controller.eventOrganizerImagesList.isEmpty
                  ? Text("")
                  : EventImageListView(
                      count: controller.eventOrganizerImagesList.length,
                      textLinkList: controller.eventOrganizerNamesList,
                      imagesList: controller.eventOrganizerImagesList,
                      icon: Icon(Icons.cancel),
                    )),
              const CommonEventTitle(text: 'Event Sponsor'),
              Obx(() => controller.selectedSponsorImage.value.isEmpty
                  ? ImageContainer(
                      imagePath: controller.selectedSponsorImage.value,
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      onTapOpenGallery: () {
                  ...
                  : ImageOpenContainer(
                      height: Dimens.imageScaleX24,
                      width: Dimens.imageScaleX24,
                      openedImagePath: controller.selectedSponsorImage.value,
                      onTapRemoveImage: () {
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventSponsorNameTextController,
              ...
              Padding(
                padding: const EdgeInsets.only(
                    ...
                    top: Dimens.imageScaleX3),
                child: CommonInputField(
                  wrapper: controller.eventSponsorTypeTextController,
                  hintText: 'Type of Sponsor',
                ),
              ),
              Align(
                alignment: Alignment.centerRight,
                  ...
                  onTap: () {
                    controller.eventSponsorNameTextController.controller.text
                        ...
                        : controller.onAddSponsorsList(
                            controller
                                .eventSponsorNameTextController.controller.text,
                            controller
                                .eventSponsorTypeTextController.controller.text,
                            controller.selectedSponsorImage.value);
                    controller.removeSponsorImage();
                    controller.eventSponsorNameTextController.controller
                        .clear();
                    controller.eventSponsorTypeTextController.controller
                        .clear();
                  },
                ),
              ),
              Obx(() => Column(
                    children: List.generate(
                        controller.eventSponsorsImagesList.length, (index) {
                      return Padding(
                        padding:
                            const EdgeInsets.only(top: Dimens.imageScaleX1),
                        child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text(
                                      controller.eventSponsorsNamesList[index]),
