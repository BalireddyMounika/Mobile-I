...
class EventPreviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Event Preview Page"),
      ),
      body: Container(
            ...
            child: Column(children: [
              ...
              const Row(
                ...
                children: [
                  ...
                  Text("Prasad Rao Pyla", style: AppStyles.tsBlackSemiBold24)
                ],
              ),
              Row(
              ...
              EventPreviewListItems(
                  text: controller.eventLocationAddress.controller.text,
                  icon: const Icon(Icons.location_on),
                  overflow: TextOverflow.clip),
              EventPreviewListItems(
                  text: controller.selectedEventStartDate.value.toString(),
                  icon: const Icon(Icons.calendar_month),
                  overflow: TextOverflow.clip),
              EventPreviewListItems(
                  text:
                      "${controller.getFormattedStartTime()} to ${controller.getFormattedScheduleTime()}",
                  icon: const Icon(Icons.watch_later_outlined),
                  overflow: TextOverflow.clip),
              EventPreviewListItems(
                  text: controller.eventCategoryDropDownText.controller.text,
                  icon: const Icon(Icons.list_alt_outlined),
                  overflow: TextOverflow.clip),
              EventPreviewListItems(
                  text: controller.virtualLinkTextController.controller.text,
              ...
              CommonEventText(
                  text: controller.descriptionTextController.controller.text),
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    EventPreviewListItems(
                        text:
                            controller.selectedEventStartDate.value.toString(),
                        icon: const Icon(Icons.calendar_month),
                        overflow: TextOverflow.clip),
                    EventPreviewListItems(
                        text:
                    ...
                    EventPreviewListItems(
                        text: controller
                            .eventCategoryDropDownText.controller.text,
                        icon: const Icon(Icons.list_alt_outlined),
                        overflow: TextOverflow.clip),
                    EventPreviewListItems(
                        text: controller
                            .virtualLinkTextController.controller.text,
                        icon: const Icon(Icons.link),
                        overflow: TextOverflow.clip),
                  ],
                ),
              ...
              CommonEventText(
                  text: controller
                      .eventInstructionTextController.controller.text),
              const CommonEventTitle(text: "Event Host"),
              CommonEventText(
                  text: controller.eventHostTextController.controller.text),
              ...
              EventPreviewImagesList(
                  count: controller.eventSponsorsImagesList.length,
                  textLinkList: controller.eventSponsorsNamesList,
                  imagesList: controller.eventSponsorsImagesList),
              const CommonEventTitle(text: "Contacts"),
              Obx(() => controller.contactLists.isEmpty
                  ? const Text("")
                  : Column(
                      children: List.generate(controller.contactLists.length,
                          (index) {
                        return Container(
                            margin: const EdgeInsets.only(
