...
class QuickInsightVoterCard extends StatelessWidget {
  final FinalIvinDataAnalytics voterResponse;
  final bool? isSelected;
  const QuickInsightVoterCard(
      {Key? key, required this.voterResponse, this.isSelected})
      : super(key: key);
