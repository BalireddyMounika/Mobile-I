...
import '../../../../widgets/common/common_edit_campaign_bar.dart';
import '../../../data/values/dimens.dart';
import '../../../themes/app_colors.dart';
import '../../../themes/app_styles.dart';

class CompaignView extends StatelessWidget {
  Campaign_view_controller controller = Get.put(Campaign_view_controller());
  CompaignView({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Obx(() => CommonInputField(
                              ...
                              isEnabled: controller
                                  .contact_mode_change_text_field.value,
                              onChanged: (text) {
                        ...
                        Obx(() => CommonInputField(
                              ...
                              onChanged: (text) {
                                controller.non_local_check_box_text_feild
                                    .value = text;
                              },
                            )),
                        Obx(() => CheckboxListTile(
                        ...
                        Obx(() => CommonInputField(
                              ...
                              onChanged: (text) {
                                controller.influencer_check_box_text_feild
                                    .value = text;
                              },
                            )),
                        Obx(() => CheckboxListTile(
                        ...
                        Obx(() => CommonInputField(
                              ...
                              onChanged: (text) {
                                controller
                                    .dissident_check_box_comments_text_feild
                                    .value = text;
                              },
                            )),
                        Obx(() => CheckboxListTile(
